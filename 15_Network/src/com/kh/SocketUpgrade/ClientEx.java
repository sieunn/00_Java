...
public class ClientEx {
	...
	private static final int SERVER_PORT = 12145; //서버가 열어놓은 포트번호, 서버=클라이언트 같아야함

	public static void main(String[] args) {
		//	Socket c = new Socket("localhost" ,  12348);
		String serverHostname = "localhost";//우리집주소 = localhost
		isRunning = true;
		//서버와 연결이 된다면 연결하고, 서버에 연결되어있는 방문자는 한번 연결하면 끝이긴하지만
