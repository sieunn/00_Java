...
public class ServerEx {
	...
	private static final int SERVER_SPACE = 50; //12390에 입장할 수 인원수
	...
	public static void main(String[] args) throws Exception {
		...
		Thread serverAcceptThread = new Thread(() -> {
			...
			while (true) {
				try {
					...
					//메모리 관리, 사람들이 순차적으로 접속할 수 있도록 해줌
		...
		//주최자가 방문자한테 메세지를 보낼수 있도록 메세지가 담겨져서 갈 수 있는 그릇 생성
