...
public class ImageCopy {
	public static void main(String[] args) {
		...
		//				폴더 경로를 모두쓰고 나면 /를 쓰고 파일이름작성.확장자
		...
		//FileInputStream 파일읽기 = new FileInputStream(원본이미지); 작성하면
		//빨간줄 나오는데 자동으로 try catch문 사용할 수 있는 선택지가 나온다.
		try {
			FileInputStream 파일읽기 = new FileInputStream(원본이미지);
			FileOutputStream 파일쓰기 = new FileOutputStream(복사이미지);

			//버퍼를 통해 데이터를 읽고 쓰기위한 배열을 설정
