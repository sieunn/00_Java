...
/*
 * write close exists mkdir 이 제일 중요 
...
public class FileEx {
	...
	public static void main(String[] args) {
		...
		if(폴더만들기.exists()) {
			...
			System.out.println(폴더만들기.getPath()); //폴더 주소확인
		}
