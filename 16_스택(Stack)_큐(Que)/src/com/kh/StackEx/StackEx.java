...
/*
 Stack(스택)
 	...
 	push() : 스택에서 값을 추가할 때는 push 사용하거나 add를 사용
 			주로 스택에서는 push를 사용,  add는 리스트나 컬렉션에서 주로 사용
 			Stack 클래서가 Vector 를 상속받아 만들어진 클래스이기 때문에 add가능
 	isEmpty() : 값이 비어있는지 확인
 	size() : 크기확인
...
public class StackEx {
	public static void main(String[] args) {
		...
		//pop() : 맨 위에 잇는 데이터를 제거하고 그 값을 반환(보여줌)
		int 맨위 = 스택.pop();
