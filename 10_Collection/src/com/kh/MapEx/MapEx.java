...
/*
 ...
 Map : 특정 키를 입력하면 해당되는 값을 얻을 수 있는 Collection객체
 	키 = key
 	값 = value
...
public class MapEx {
	public static void main(String[] args) {
		...
		//키는 유일해야함, 키의 값은 중복이 될수 없음, 맨 마지막 값으로 덮어씌워짐
		학생들.put("철수", 80);
		
		//학생들의 성적 출력하기
		//for each 학생들에 들어잇는 key를 모두 가지고 와서 배열해놓는 keySet()을 활용
