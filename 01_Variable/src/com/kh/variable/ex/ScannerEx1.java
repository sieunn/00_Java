...
public class ScannerEx1 {
	...
	public static void main(String[] args) {
		/*
		 ...
		 Scanner.next() : 공백없이 단어(string) 1개 입력가능
		 Scanner.nextLine() : 공백 포함해서 문자열(string) 1개 입력
		...
		sc.nextLine(); // next() 뒤에 남아있는 버퍼값을 Line안에 넣어줌(제거해줌)
		//그런데 버퍼값은 우리가 눈으로 보거나 저장을 해야할 이유가 없기 때문에
		//앞에 자료형이나 변수명을 사용해서 버퍼를 넣어 저장해야할 이유가 없어
		//sc.nextLine()으로만 사용
