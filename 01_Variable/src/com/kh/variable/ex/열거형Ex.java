...
Enum(열거형) 
 ...
 메서드
 	...
 	valueOf(String 이름) 	  : 지정된 이름과 일치하는 Enum 상수를 반환
 	ordinal() 			  : Enum 상수의 순서를 전달
 	name() 				  : Enum 상수의 이름을 반환
 	compareTo(EnumType e) : 다른 Enum 상수와 순서 비교
 	toString() 			  : Enum 상수의 문자열 표현을 반환
 	getClass() 			  : Enum 클래스의 Class객체를 반환
...
public class 열거형Ex {
	...
	public static void main(String[] args) {
		...
		//vlaueOf(String 이름) : 이름과 일치하는 Enum 상수를 반환
		//exception 감싸서 일치하는 것이 없으면 예외처리 진행
		계절 봄 = 계절.valueOf("봄");
		...
		//getClass() : 클래스 객체 반환
		System.out.println("클래스의 객체: " + 계절들.getClass());
